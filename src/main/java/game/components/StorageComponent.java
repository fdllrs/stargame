...
public class StorageComponent {
	...
	public boolean attemptMoveItemsTo(StorageComponent otherStorage, ItemType item, int amount) {

		if (!canMoveItemsTo(otherStorage, item, amount)) return false;
		attemptWithdraw(item, amount);
		otherStorage.deposit(item, amount);
		return true;
	}

	public boolean attemptWithdraw(ItemType item, int amount) {
	...
	private boolean canMoveItemsTo(StorageComponent otherStorage, ItemType item, int amount) {
