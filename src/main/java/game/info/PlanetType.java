...
public enum PlanetType {
	ROCKY(List.of(RawResource.METAL)), GAS_GIANT(List.of(RawResource.HYDROGEN)), ICE_GIANT(List.of(
			RawResource.WATER,
			RawResource.HYDROGEN)), ORGANIC(List.of(RawResource.ORGANICS, RawResource.METAL));
