...
public class PlanetStoragePanel extends UIPanel {
	...
	public PlanetStoragePanel(float x,
			float y,
			float width,
			float height,
			Vector4f color,
		...
		this.animation = new UISlideAnimation(this, 11.0f);
	}
	...
	public void rebuildElements() {
		...
		setPanelTitle(currentPlanet.getName() + " - Cargo");
		...
		for (UIElement element : UIStorageTab.build(currentPlanet.getStorage(),
													playerStorage,
													font,
													width,
													onRebuild,
