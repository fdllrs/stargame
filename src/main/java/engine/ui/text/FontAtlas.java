...
public class FontAtlas {
	...
	private final org.joml.Vector2f uvScale = new org.joml.Vector2f();
	private final org.joml.Vector2f uvOffset = new org.joml.Vector2f();
	...
	public void renderText(ShaderProgram shader,
		...
		for (int i = 0; i < text.length(); i++) {
			...
			transform.identity().translate(cursorX + info.xOffset() * fontSizeMultiplier,
										   startY + info.yOffset() * fontSizeMultiplier,
										   0.0f).scale(info.width() * fontSizeMultiplier,
